...
INPUT_JSONL  = r"C:\Users\kodur\Downloads\Whissle\thchs-30\manifest_test1.jsonl"
OUTPUT_JSONL = r"C:\Users\kodur\Downloads\Whissle\thchs-30\test1_intermediate.jsonl"
...
# === Emotion mapping for r-f/wav2vec-english-speech-emotion-recognition ===
...
# === **Updated**: use r-f/wav2vec-english-speech-emotion-recognition here ===
...
with open(OUTPUT_JSONL, 'a', encoding='utf-8') as fout:
    for rec in tqdm(all_records, desc="Processing"):
        ...
        # --- **updated**: emotion inference with 7-class Wav2Vec2 model ---
        ...
        # --- sentence segmentation (unchanged) ---
